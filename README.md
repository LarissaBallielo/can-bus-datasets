...
python_obd/: dados coletados usando a biblioteca python-OBD, que já decodifica os PIDs.
python_can/: dados coletados usando a biblioteca python-can, com os frames CAN mais crus, sem decodificação de PID.
data/synthetic/
